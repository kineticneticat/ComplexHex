...
public class ParameticLineEntity extends Entity {
    private static final EntityDataAccessor<CompoundTag> XPRESSION =
            SynchedEntityData.defineId(ParameticLineEntity.class, EntityDataSerializers.COMPOUND_TAG);
    ...
    public ParameticLineEntity(EntityType<?> entityType, Level level) {
