...
interface SpellActionButPushesAnIota : Action {
    val argc: Int
    ...
    data class Result(val effect: RenderedSpell, val cost: Long, val particles: List<ParticleSpray>, val iotas: List<Iota>, val opCount: Long = 1)
}