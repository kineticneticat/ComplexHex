...
import hexdoc_complexhex

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class ComplexhexPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return ComplexhexModPlugin(branch=branch)


class ComplexhexModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "complexhex"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_complexhex, "_templates"
